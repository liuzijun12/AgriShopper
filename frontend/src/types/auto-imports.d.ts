...
declare global {
  ...
  const CartAPI: typeof import('../api/index')['CartAPI']
  const CategoryAPI: typeof import('../api/index')['CategoryAPI']
  const CommonUtil: typeof import('wot-design-uni')['CommonUtil']
  const EffectScope: typeof import('vue')['EffectScope']
  const FavoriteAPI: typeof import('../api/index')['FavoriteAPI']
  const FileAPI: typeof import('../api/index')['FileAPI']
  const ProductAPI: typeof import('../api/index')['ProductAPI']
  const Storage: typeof import('../utils/storage')['Storage']
  const UserAPI: typeof import('../api/index')['UserAPI']
  ...
  const cart: typeof import('../api/cart')['default']
  const category: typeof import('../api/category')['default']
  const checkLogin: typeof import('../utils/auth')['checkLogin']
  const checkLoginStatus: typeof import('../utils/routeGuard')['checkLoginStatus']
  const checkPageAccess: typeof import('../utils/routeGuard')['checkPageAccess']
  const clearAll: typeof import('../utils/storage')['clearAll']
  const clearAuthInfo: typeof import('../utils/storage')['clearAuthInfo']
  ...
  const effectScope: typeof import('vue')['effectScope']
  const favorite: typeof import('../api/favorite')['default']
  ...
  const getCurrentUser: typeof import('../utils/routeGuard')['getCurrentUser']
  ...
  const goToHome: typeof import('../utils/navigationHandler.js')['goToHome']
  ...
  const interceptNavigation: typeof import('../utils/navigationHandler.js')['interceptNavigation']
  ...
  const navigateToLogin: typeof import('../utils/routeGuard')['navigateToLogin']
  ...
  const removeRefreshToken: typeof import('../utils/storage')['removeRefreshToken']
  const removeToken: typeof import('../utils/storage')['removeToken']
  const removeUserInfo: typeof import('../utils/storage')['removeUserInfo']
  ...
  const routeLogout: typeof import('../utils/routeGuard')['routeLogout']
  const setAccessToken: typeof import('../utils/auth')['setAccessToken']
  const setActivePinia: typeof import('pinia')['setActivePinia']
  const setMapStoreSuffix: typeof import('pinia')['setMapStoreSuffix']
  const setNavigationBarButton: typeof import('../utils/navigationHandler.js')['setNavigationBarButton']
  const setRefreshToken: typeof import('../utils/storage')['setRefreshToken']
...
declare module 'vue' {
  ...
  interface ComponentCustomProperties {
    ...
    readonly CartAPI: UnwrapRef<typeof import('../api/index')['CartAPI']>
    readonly CategoryAPI: UnwrapRef<typeof import('../api/index')['CategoryAPI']>
    readonly CommonUtil: UnwrapRef<typeof import('wot-design-uni')['CommonUtil']>
    readonly EffectScope: UnwrapRef<typeof import('vue')['EffectScope']>
    readonly FavoriteAPI: UnwrapRef<typeof import('../api/index')['FavoriteAPI']>
    readonly FileAPI: UnwrapRef<typeof import('../api/index')['FileAPI']>
    readonly ProductAPI: UnwrapRef<typeof import('../api/index')['ProductAPI']>
    readonly UserAPI: UnwrapRef<typeof import('../api/index')['UserAPI']>
    readonly acceptHMRUpdate: UnwrapRef<typeof import('pinia')['acceptHMRUpdate']>
    readonly auth: UnwrapRef<typeof import('../api/auth')['default']>
    readonly cart: UnwrapRef<typeof import('../api/cart')['default']>
    readonly category: UnwrapRef<typeof import('../api/category')['default']>
    readonly checkLoginStatus: UnwrapRef<typeof import('../utils/routeGuard')['checkLoginStatus']>
    readonly checkPageAccess: UnwrapRef<typeof import('../utils/routeGuard')['checkPageAccess']>
    readonly clearAuthInfo: UnwrapRef<typeof import('../utils/storage')['clearAuthInfo']>
    ...
    readonly effectScope: UnwrapRef<typeof import('vue')['effectScope']>
    readonly favorite: UnwrapRef<typeof import('../api/favorite')['default']>
    readonly file: UnwrapRef<typeof import('../api/file')['default']>
    readonly getActivePinia: UnwrapRef<typeof import('pinia')['getActivePinia']>
    readonly getCurrentInstance: UnwrapRef<typeof import('vue')['getCurrentInstance']>
    readonly getCurrentScope: UnwrapRef<typeof import('vue')['getCurrentScope']>
    readonly getCurrentUser: UnwrapRef<typeof import('../utils/routeGuard')['getCurrentUser']>
    ...
    readonly goToHome: UnwrapRef<typeof import('../utils/navigationHandler.js')['goToHome']>
    readonly h: UnwrapRef<typeof import('vue')['h']>
    readonly inject: UnwrapRef<typeof import('vue')['inject']>
    readonly interceptNavigation: UnwrapRef<typeof import('../utils/navigationHandler.js')['interceptNavigation']>
    ...
    readonly navigateToLogin: UnwrapRef<typeof import('../utils/routeGuard')['navigateToLogin']>
    ...
    readonly removeRefreshToken: UnwrapRef<typeof import('../utils/storage')['removeRefreshToken']>
    readonly removeToken: UnwrapRef<typeof import('../utils/storage')['removeToken']>
    readonly removeUserInfo: UnwrapRef<typeof import('../utils/storage')['removeUserInfo']>
    readonly request: UnwrapRef<typeof import('../utils/request')['default']>
    readonly resolveComponent: UnwrapRef<typeof import('vue')['resolveComponent']>
    readonly routeLogout: UnwrapRef<typeof import('../utils/routeGuard')['routeLogout']>
    readonly setActivePinia: UnwrapRef<typeof import('pinia')['setActivePinia']>
    readonly setMapStoreSuffix: UnwrapRef<typeof import('pinia')['setMapStoreSuffix']>
    readonly setNavigationBarButton: UnwrapRef<typeof import('../utils/navigationHandler.js')['setNavigationBarButton']>
    readonly setRefreshToken: UnwrapRef<typeof import('../utils/storage')['setRefreshToken']>
