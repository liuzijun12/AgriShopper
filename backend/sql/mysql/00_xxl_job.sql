...
CREATE DATABASE IF NOT EXISTS xxl_job CHARACTER SET utf8mb4 DEFAULT COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `xxl_job_registry` (
  ...
  `registry_group` varchar(255) NOT NULL COMMENT '注册组',
...
CREATE TABLE `xxl_job_info` (
  ...
  `trigger_prev_time` bigint(13) NOT NULL DEFAULT '0' COMMENT '上次调度时间',
  `trigger_next_time` bigint(13) NOT NULL DEFAULT '0' COMMENT '下次调度时间',
  `trigger_last_time` bigint(13) NOT NULL DEFAULT '0' COMMENT '上次执行时间',
  `trigger_fail_time` bigint(13) NOT NULL DEFAULT '0' COMMENT '上次失败时间',
  `trigger_fail_count` int(11) NOT NULL DEFAULT '0' COMMENT '上次失败次数',
  PRIMARY KEY (`id`),
  KEY `idx_trigger_status` (`trigger_status`),
  KEY `idx_job_group` (`job_group`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='调度信息表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='调度日志报表：用户用此表实现调度统计';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='GLUE日志：用于GLUE版本管理';
