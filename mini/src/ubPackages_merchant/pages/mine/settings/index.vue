...
import { checkLogin } from "@/ubPackages_merchant/utils/auth";
...
const navigateToProfile = () => {
  if (checkLogin()) {
    uni.navigateTo({
      url: "/ubPackages_merchant/pages/mine/profile/index",
    });
  }
};
...
const navigateToAccount = () => {
  if (checkLogin()) {
    uni.navigateTo({
      url: "/ubPackages_merchant/pages/mine/settings/account/index",
    });
  }
};
...
const navigateToTheme = () => {
  uni.navigateTo({
    url: "/ubPackages_merchant/pages/mine/settings/theme/index",
  });
};
...
const navigateToUserAgreement = () => {
  uni.navigateTo({
    url: "/ubPackages_merchant/pages/mine/settings/agreement/index",
  });
};
...
const navigateToAbout = () => {
  uni.navigateTo({
    url: "/ubPackages_merchant/pages/mine/about/index",
  });
};

// 网络测试
const navigateToNetworkTest = () => {
  uni.navigateTo({ url: "/ubPackages_merchant/pages/mine/settings/network/index" });
};
